...
function AdminPage() {
  ...
  const fetchFoodItems = async () => {
    try {
      const response = await axios.get('https://my-project-5-v43w.onrender.com/home/');
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get('https://my-project-5-v43w.onrender.com/order/');
  ...
  const fetchCustomers = async () => {
    try {
      const response = await axios.get('https://my-project-5-v43w.onrender.com/cust/');
  ...
  const handleFoodSubmit = async (e) => {
    ...
    try {
      if (isEditingFood) {
        await axios.put(`https://my-project-5-v43w.onrender.com/home/${foodForm.id}/`, foodForm);
      } else {
        await axios.post('https://my-project-5-v43w.onrender.com/home/', foodForm);
      }
  ...
  const handleCustomerSubmit = async (e) => {
    ...
    try {
      if (isEditingCustomer) {
        await axios.put(`https://my-project-5-v43w.onrender.com/cust/${customerForm.id}/`, customerForm);
      } else {
        await axios.post('https://my-project-5-v43w.onrender.com/cust/', customerForm);
      }
  ...
  const handleOrderSubmit = async (e) => {
    ...
    try {
      if (isEditingOrder) {
        await axios.put(`https://my-project-5-v43w.onrender.com/order/${orderForm.id}/`, orderForm);
      } else {
        await axios.post('https://my-project-5-v43w.onrender.com/order/', orderForm);
      }
  ...
  const handleDeleteFood = async (id) => {
    try {
      await axios.delete(`https://my-project-5-v43w.onrender.com/home/${id}/`);
      fetchFoodItems();
    } catch (error) {
  ...
  const handleDeleteCustomer = async (id) => {
    try {
      await axios.delete(`https://my-project-5-v43w.onrender.com/cust/${id}/`);
      fetchCustomers();
    } catch (error) {
  ...
  const handleDeleteOrder = async (id) => {
    try {
      await axios.delete(`https://my-project-5-v43w.onrender.com/order/${id}/`);
      fetchOrders();
    } catch (error) {
